...
@property (strong, nonatomic) NSArray *reindeer;
@end
...
- (void)viewDidLoad
{
    ...
    _reindeer = [NSArray arrayWithObjects:@"Dasher",@"Dancer",@"Prancer",@"Vixen",
                                        @"Comet",@"Cupid",@"Donner",@"Blitzen",@"Rudolph",nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [self.reindeer objectAtIndex:indexPath.row];
